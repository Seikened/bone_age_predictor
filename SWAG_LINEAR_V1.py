...
def main():
    ...
    # Cargar modelo ViT-B/16 con SWAG_LINEAR_V1
    ...
    swa_scheduler = SWALR(
        optimizer, anneal_strategy="linear", anneal_epochs=5, swa_lr=LR
    )
    ...
    torch.save(swa_model.state_dict(), "vit_bone_age_swag_linear.pth")

    print(
        "Entrenamiento completado. Modelo SWAG LINEAR guardado en vit_bone_age_swag_linear.pth"
    )
