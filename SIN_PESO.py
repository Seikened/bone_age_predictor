...
def main():
    ...
    # Cargar modelo ViT-B/16 con SWAG_E2E_V1
    weights = None
    ...
    torch.save(swa_model.state_dict(), "vit_bone_age.pth")

    print("Entrenamiento completado. Modelo SWAG LINEAR guardado en vit_bone_age.pth")
    ...
    with torch.no_grad():
        ...
        for i in range(min(5000, len(test_images))):  # Mostrar 5 ejemplos
        ...
        print(f"Promedio de los errores: {promedio:.2f}")
